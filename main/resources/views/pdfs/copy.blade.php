...
<body width="100%"
    ...
    style="margin: 12px -20px 0 -20px; padding: 0; font-size: 12pt; line-height: .1; font-family: Arial, Helvetica, sans-serif;">
                ...
                <td height="70px">
                    <div class="noticia" style="margin-right: 15px; padding-right: 40px">
                        <img class="derecha" width="90px" src="{{ asset('/imgs/items/' . $elemetn->qr . '.png') }}"
                            alt="">
                        <aside>
                            <p style="line-height: 0.9 !important ; ">{{ $elemetn->name }}</p>
                            <p>{{ $elemetn->sku }}</p>
                            <p>{{ $elemetn->sheet_size }}</p>
                            <p>{{ $elemetn->packing }}</p>
                        </aside>
                ...
                <td height="70px">
                    <div class="noticia" style="margin-right: 15px; padding-right: 40px">
                        <img class="derecha" width="90px" src="{{ asset('/imgs/items/' . $elemetn->qr . '.png') }}"
                            alt="">
                        <aside>
                            <p style="line-height: 1.1 !important ; ">{{ $elemetn->name }}</p>
                            <p>{{ $elemetn->sku }}</p>
                            <p>{{ $elemetn->sheet_size }}</p>
                            <p>{{ $elemetn->packing }}</p>
                        </aside>
                ...
                <td height="70px">
                    <div class="noticia" style="margin-right: 15px; padding-right: 40px">
                        <img class="derecha" width="90px"
                            src="{{ asset('/imgs/items/' . $elemetn->qr . '.png') }}" alt="">
                        <aside>
                            <p style="line-height: 1 !important ; ">{{ $elemetn->name }}</p>
                            <p>{{ $elemetn->sku }}</p>
                            <p>{{ $elemetn->sheet_size }}</p>
                            <p>{{ $elemetn->packing }}</p>
                        </aside>
